...
const Tabs: React.FC<TabsProps> = ({
  ...
  const baseNavClasses = "-mb-px flex space-x-2 overflow-x-auto relative";
    ...
    <div className="border-b border-gray-200 dark:border-gray-800">
      ...
      {tabs.map((tab, index) => (
        <button
          ...
          className={`inline-flex flex-1 justify-center items-center border-b-2 px-2.5 py-2 text-sm font-medium transition-colors duration-200 ease-in-out ${
            activeTab === tab.value
